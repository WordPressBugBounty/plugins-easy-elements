...
<div class="ee--icon-box <?php echo esc_attr($icon_direction); ?> eel-bf-<?php echo esc_attr( $item_hover_styles ); ?> eel-info-<?php echo esc_attr($info_skin); ?>">
        ...
        <div class="eel-info-content">
            ...
            <?php endif; ?>
            <?php
            foreach ( $settings['_features'] as $easyel_item ) {
                echo '<div class="feature-item">';
                    \Elementor\Icons_Manager::render_icon(
                        $easyel_item['_feature_icon'],
                        [ 'aria-hidden' => 'true',
                        'class'       => 'eel-info-icon' ]
                    );
                    echo '<span>' . esc_html( $easyel_item['_feature'] ) . '</span>';
                echo '</div>';
            }
            ?>

            <?php if ( !empty($settings['show_read_more']) && $settings['show_read_more'] === 'yes' ) : ?>
                <div class="eel-read-more <?php echo esc_attr($settings['button_text_align']); ?>">
                    <?php if ( $link ) : ?>
