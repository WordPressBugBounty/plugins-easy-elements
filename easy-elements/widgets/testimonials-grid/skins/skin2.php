...
$easyel_avatar_image_top = ($settings['avatar_image_top'] === 'yes') ? 'eel-avatar-image-top' : '';
?>
<div class="ee--tstml-inner-wrap <?php echo esc_attr($skin); ?> <?php echo esc_attr($easyel_avatar_image_top); ?>">
